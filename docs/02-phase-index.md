...
| Phase 155.0 | complete | Scholar Chat session rail UI | `src/App.tsx`, `src/workspaces/ScholarChatWorkspace.tsx`, `src/styles.css`, `docs/02-phase-index.md`, `docs/05-product-ux-reorientation.md`, `docs/12-roadmap.md` | nested session history is now visible inside Scholar Chat; preview/check behavior stays explicit and transcript restore remains session-scoped |
| Phase 156.0 | complete | Scholar Chat session rename/delete controls | `src/App.tsx`, `src/workspaces/ScholarChatWorkspace.tsx`, `src/styles.css`, `docs/02-phase-index.md`, `docs/05-product-ux-reorientation.md`, `docs/12-roadmap.md` | rename/delete stay explicit in the session rail; active-session deletion returns to a fresh local draft view and transcript restore stays session-scoped |
| Phase 157.0 | complete | Frontend browser smoke harness | `playwright.config.ts`, `tests/browser-smoke.spec.ts`, `package.json`, `package-lock.json`, `docs/02-phase-index.md`, `docs/05-product-ux-reorientation.md`, `docs/12-roadmap.md` | browser-only smoke coverage loads the Vite app with a test-only Tauri shim and does not change product semantics |
| Phase 158.0 | planned | CI browser smoke integration | `.github/workflows/verify.yml`, `docs/02-phase-index.md`, `docs/05-product-ux-reorientation.md`, `docs/12-roadmap.md` | verify CI now runs the browser smoke alongside the existing build/check gates |
