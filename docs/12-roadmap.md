...
| Current Phase 123.0 | project knowledge base / GitHub Wiki readiness docs pass |
...
Phase 123.0 is a docs-only project integration pass. It adds a professional project knowledge base for external orientation and GitHub Wiki readiness, and it does not change production code, frontend code, backend code, Tauri command wiring, or tests.
...
Phase 123.0 is this docs-only project knowledge base / GitHub Wiki readiness pass.
