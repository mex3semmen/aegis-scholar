...
Phase 153.0 performs the first low-risk mechanical extraction from src/App.tsx. It moves pure frontend types and stateless sanitization / formatting helpers into shared modules while leaving constants, JSX, signals, loaders, invoke handlers, mutation flows, and product behavior unchanged.
